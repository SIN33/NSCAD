...
namespace NSCAD
{
	...
	class NodePointArcCenter : INSNodePoint
	{
		...
		#region INSNodePoint Members Impl
	...
	class NodePointArcRadius : INSNodePoint
	{
		protected Arc _owner;
		protected Arc _clone;
		protected float m_originalValue;
		protected float m_endValue;
		public NodePointArcRadius(Arc owner)
		{
			_owner = owner;
			_clone = _owner.Clone() as Arc;
			_clone.CurrentPoint = _owner.CurrentPoint;
			m_originalValue = _owner.Radius;
		}
		#region INSNodePoint Members Imple
		public INSDrawObject GetClone()
		{
			return _clone;
		}
		...
		public virtual void SetPosition(UnitPoint pos)
		{
			_clone.OnMouseMove(null, pos);
		}
		public virtual void Finish()
		{
			m_endValue = _clone.Radius;
			_owner.Radius = _clone.Radius;
		...
		public virtual void Undo()
		{
			_owner.Radius = m_originalValue;
		}
		public virtual void Redo()
		{
			_owner.Radius = m_endValue;
		}
		public void OnKeyDown(INSCanvas canvas, KeyEventArgs e)
		{
		}
	...
	class NodePointArcAngle : INSNodePoint
	{
		protected Arc _owner;
		protected Arc _clone;
		...
		public NodePointArcAngle(Arc owner)
		{
			...
			_clone = _owner.Clone() as Arc;
			_clone.CurrentPoint = _owner.CurrentPoint;
			m_originalA1 = _owner.StartAngle;
			m_originalA2 = _owner.EndAngle;
		...
		public virtual void Finish()
		{
			m_endA1 = _clone.StartAngle;
			m_endA2 = _clone.EndAngle;
			_owner.Copy(_clone);
			_clone = null;
		}
		public void Cancel()
		...
		public virtual void Undo()
		{
			_owner.StartAngle = m_originalA1;
			_owner.EndAngle = m_originalA2;
		}
		public virtual void Redo()
		{
			_owner.StartAngle = m_endA1;
			_owner.EndAngle = m_endA2;
		}
		public void OnKeyDown(INSCanvas canvas, KeyEventArgs e)
		{
		}
	...
	class Arc : DrawObjectBase, INSArc, INSDrawObject, INSSerialize
	{
		...
		public virtual void OnMouseUp(INSCanvas canvas, UnitPoint point, INSSnapPoint snappoint)
		{
		}
		...
		public virtual bool PointInObject(INSCanvas canvas, UnitPoint point)
		{
		...
		public virtual bool ObjectInRectangle(INSCanvas canvas, RectangleF rect, bool anyPoint)
		{
		...
		public virtual INSNodePoint NodePoint(INSCanvas canvas, UnitPoint point)
		{
			float thWidth = Line.ThresholdWidth(canvas, Width, ThresholdPixel);
			if (HitUtil.PointInPoint(m_center, point, thWidth))
		...
		public virtual INSSnapPoint SnapPoint(INSCanvas canvas, UnitPoint point, List<INSDrawObject> otherobj, Type[] runningsnaptypes, Type usersnaptype)
		{
			float thWidth = Line.ThresholdWidth(canvas, Width, ThresholdPixel);
			...
			{
				INSDrawObject drawingObject = canvas.CurrentObject;
		...
		protected virtual void DrawNodes(INSCanvas canvas)
		{
	...
	class Circle : Arc
	{
		...
		protected override void DrawNodes(INSCanvas canvas)
		{
		...
		public override INSNodePoint NodePoint(INSCanvas canvas, UnitPoint point)
		{
			float thWidth = Line.ThresholdWidth(canvas, Width, ThresholdPixel);
		...
		{
			return string.Format("‰~{0}, r={1:f4}", Center.PosAsString(), Radius);
		}
	}
}
