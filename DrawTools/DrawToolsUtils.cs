...
namespace NSCAD
{
	public class DrawUtils
	{
		...
		static public Pen SelectedPen
		{
			get
			{
				...
				{
					m_selectedPen = new Pen(Color.GreenYellow, 1);
					m_selectedPen.DashStyle = DashStyle.Dash;
				}
				return m_selectedPen;
			}
		}
		static public void DrawNode(INSCanvas canvas, UnitPoint nodepoint)
		{
		...
		static public void DrawTriangleNode(INSCanvas canvas, UnitPoint nodepoint)
		{
	...
	abstract class DrawObjectBase
	{
		...
		abstract public void InitializeFromModel(UnitPoint point, DrawingLayer layer, INSSnapPoint snap);
