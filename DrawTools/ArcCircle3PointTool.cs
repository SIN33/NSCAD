...
namespace NSCAD
{
	class NodePointArc3PointPoint : INSNodePoint
	{
	...
	class Arc3Point : DrawObjectBase, INSArc, INSDrawObject, INSSerialize
	{
		...
		void DrawArc(INSCanvas canvas, RectangleF unitrect)
		{
		...
		void Draw3P132(INSCanvas canvas, RectangleF unitrect)
		{
		...
		void Draw3P123(INSCanvas canvas, RectangleF unitrect)
		{
		...
		void MoveMouse3P132(INSCanvas canvas, UnitPoint point)
		{
		...
		void MoveMouse3P123(INSCanvas canvas, UnitPoint point)
		{
			if (m_curPoint == eCurrentPoint.p1)
			{
				m_p1 = point;
		...
		eDrawObjectMouseDown MouseDown3P132(INSCanvas canvas, UnitPoint point, INSSnapPoint snappoint)
		{
		...
		eDrawObjectMouseDown MouseDown3P123(INSCanvas canvas, UnitPoint point, INSSnapPoint snappoint)
		{
			OnMouseMove(canvas, point);
			if (m_curPoint == eCurrentPoint.p1)
			{
		...
		{
			return string.Format("‰~ŒÊ{0}, r={1:f4}, A1={2:f4}, A2={3:f4}", Center.PosAsString(), Radius, StartAngle, EndAngle);
		}
		#endregion
		#region ISerialize
